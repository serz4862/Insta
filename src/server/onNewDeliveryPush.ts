/**
 * Firebase Cloud Functions source (Node). Not imported by the Expo app.
 * To deploy: copy this folder to a `functions` package or wire `firebase.json`
 * `functions.source` to a directory that compiles this with firebase-admin / firebase-functions.
 */
